...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\input{sections/explicacioncodigo}
		\input{sections/explicacioncodigouno}
		\input{sections/explicacioncodigodos}
		\input{sections/explicacioncodigotres}
		\input{sections/explicacioncodigocuatro}
		\input{sections/explicacioncodigocinco}
		\input{sections/explicacioncodigoseis}
		\input{sections/explicacioncodigosiete}
